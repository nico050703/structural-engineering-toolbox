...
# -----------------------------
reaction_lbs = line_load_plf * span_ft
moment_lbft = line_load_plf * span_ft**2 / 2
...
# -----------------------------
standard_deflection_in = (line_load_service_pli * span_in**4) / (8*EI)
LL_deflection_in = (line_load_LL_only_pli * span_in**4) / (8*EI)
